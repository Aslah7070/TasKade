...
export function ImagesSliderDemo() {
  ...
  return (
    <ImagesSlider className="h-[30rem] shadow-[0_4px_30px_rgba(255,255,255,0.2)] w-[35rem] rounded-2xl" images={images}>
      <motion.div
        initial={{
          opacity: 0,
          y: -80,
        ...
        className="z-50 flex flex-col  justify-between  h-full items-end"
      >
